...
class FilterCategoryBranddapter(var context: Context, var list : ArrayList<VehicleListModel>) :
    RecyclerView.Adapter<FilterCategoryBranddapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflater: LayoutInflater = LayoutInflater.from(context)
        val view: View = inflater.inflate(R.layout.category_brand_subitem, parent,false)
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun onbind(vehicleListModel: VehicleListModel){
            itemView.tvBrandName.setText(vehicleListModel.bikeName)
        }
    }
