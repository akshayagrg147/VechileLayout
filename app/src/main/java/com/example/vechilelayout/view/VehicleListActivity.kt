...
class VehicleListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llFilter.setOnClickListener {
            ...
            filterCtegoryList.add(VehicleListModel("Engine",R.drawable.ic_engine))
            filterCtegoryList.add(VehicleListModel("Body Dimensions",R.drawable.ic_body_dimension))
            filterCtegoryList.add(VehicleListModel("Chasis & Suspensions",R.drawable.ic_suspensions))
            filterCtegoryList.add(VehicleListModel("Types & Brakes",R.drawable.ic_tyres))
