...
class DocumentPanCardUploadActivity : AppCompatActivity() {

    lateinit var sheetBehavior: BottomSheetBehavior<*>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_document_pan_upload)
        ...
        tvSkip.setOnClickListener {
            startActivity(Intent(this, DocumentAdharCardUploadActivity::class.java))
        }
